    ...
    if (nodeType == XML_NODE_TYPE_START_ELEMENT) {
        ...
        switch (project_state[depth-1]) {
            ...
            case PROJECT_STATE_NATURE:
                ...
                else if (strcmp(MCUProjectNature, value) == 0)
                    project_has.bits.MCUProjectNature = 1;
                else if (strcmp(MCUCubeProjectNature, value) == 0)
                    project_has.bits.MCUCubeProjectNature = 1;
                else if (strcmp(MCUCubeIdeServicesRevAProjectNature, value) == 0)
                    project_has.bits.MCUCubeIdeServicesRevAProjectNature = 1;
                else if (strcmp(MCUCubeIdeServicesRevAev2ProjectNature , value) == 0)
                    project_has.bits.MCUCubeIdeServicesRevAProjectNature = 1;
                else if (strcmp(MCUAdvancedStructureProjectNature, value) == 0)
                    project_has.bits.MCUAdvancedStructureProjectNature = 1;
                else if (strcmp(MCUEndUserDisabledTrustZoneProjectNature, value) == 0)
                    project_has.bits.MCUEndUserDisabledTrustZoneProjectNature = 1;
                else if (strcmp(MCUSingleCpuProjectNature, value) == 0)
                    project_has.bits.MCUSingleCpuProjectNature = 1;
                else if (strcmp(MCURootProjectNature, value) == 0)
